...
public class CityController {
    ...
    public City getCity(@RequestParam("id") Long id){
        ResponseEntity<City> forObject = restTemplate.getForEntity("Http://microservice-config-server-production-ribbon/getCity?id=" + id, City.class);
    ...
    public void  findUserInstance(){
        ServiceInstance choose = this.loadBalanced.choose("microservice-config-server-production-ribbon");
